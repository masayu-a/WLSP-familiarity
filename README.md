# WLSP-familiarity (version 2.0) (2021/04/24)
...
### version 3 の予告 (NLP2022 で発表予定: 2021/10/05 追記)
- 「表層形＋分類語彙表番号」についての親密度ではなく、**「表層形」のみについての親密度**に変更します（多義語の扱い）
- 2021年データを追加します。
- 200回答未満の実験協力者は継続して排除します。
